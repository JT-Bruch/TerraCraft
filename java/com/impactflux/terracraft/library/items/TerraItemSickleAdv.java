...
import com.impactflux.terracraft.library.TerraCoreUtils;
...
public class TerraItemSickleAdv extends TerraItemToolAdv {

	public int radius = 3;

	public TerraItemSickleAdv(Item.ToolMaterial toolMaterial) {
	...
	protected void harvestBlock(World world, int x, int y, int z, EntityPlayer player) {
		...
		if (ServerHelper.isServerWorld(world) && block.equals(Blocks.vine)) {
			TerraCoreUtils.dropItemStackIntoWorldWithVelocity(new ItemStack(Blocks.vine), world, x, y, z);
		}
